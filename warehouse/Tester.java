...
public class Tester {
	...
	public static void main(String[] args) {
		...
		Warehouse warehouse = new Warehouse(5,lengths, new int[] {10,30,4,15,15});
		
		//TESTING SORT
		warehouse.sort();
		String testSort = "0-th shelf ( 1 - 4 ) : \n1-th shelf ( 3 - 30 ) : \n2-th shelf ( 4 - 10 ) : \n3-th shelf ( 5 - 15 ) : \n4-th shelf ( 6 - 15 ) : \n";
		...
		Box b5 = new Box(1, 4, "Box 5");
		Box b6 = new Box(1, 2, "Box 6");
		Box b7 = new Box(1, 40, "Box 7");
		
		
		// TESTING ADDBOX
		String testAddShelf = "0-th shelf ( 1 - 0 ) : Box 5, \n1-th shelf ( 3 - 30 ) : \n2-th shelf ( 4 - 10 ) : \n3-th shelf ( 5 - 15 ) : \n4-th shelf ( 6 - 5 ) : Box 2, \n";
		warehouse.storage[4].addBox(b2);
		warehouse.storage[0].addBox(b5);
		...
		String testAddW = "0-th shelf ( 1 - 0 ) : Box 5, \n1-th shelf ( 3 - 10 ) : Box 3, Box 4, \n2-th shelf ( 4 - 10 ) : \n3-th shelf ( 5 - 15 ) : \n4-th shelf ( 6 - 5 ) : Box 2, \n";
		warehouse.addBox(b7);
		warehouse.addBox(b3);
		warehouse.addBox(b4);
		System.out.println(warehouse.print());
		System.out.println(b3.previous);
		if (warehouse.print().equals(testAddW) & b3.previous == null){
		...
		// TESTING REMOVEBOX
		String testremoveBox = "0-th shelf ( 1 - 0 ) : Box 5, \n1-th shelf ( 3 - 20 ) : Box 4, \n2-th shelf ( 4 - 10 ) : \n3-th shelf ( 5 - 15 ) : \n4-th shelf ( 6 - 5 ) : Box 2, \n";
		warehouse.storage[1].removeBox("Box 3");
		warehouse.storage[2].removeBox("Box 2");
		if (warehouse.print().equals(testremoveBox) && b3.previous == null && b3.next == null && b4.previous == null && b4.next == null && b2.previous == null && b2.next== null){
