...
public class Tester {
	...
	public static void main(String[] args) {
		...
		/*	
		String sol89 = "Building 3(1987 , 55)\n"+"older than Building 3(1987 , 55) :\n"+"Building 6(1985 , 60)\n";
		sol89 += "same age as Building 6(1985 , 60) :\n"+ "Building 4(1985 , 50)\n"+"same age as Building 4(1985 , 50) :\n"+"Building 5(1985 , 45)\n";
		sol89 +="younger than Building 6(1985 , 60) :\n"+"Building 7(1986 , 55)\n"+"same age as Building 3(1987 , 55) :\n";
		sol89 += "Building 1(1987 , 50)\n"+"younger than Building 3(1987 , 55) :\n"+"Building 2(1988 , 60)\n";
		sol89 += "younger than Building 2(1988 , 60) :\n"+"Building 8(1995 , 55)\n";
		
		Building b3 = new Building(new OneBuilding("Building 1", 1987, 50, 2025, 35));
		OneBuilding ob6=new OneBuilding("Building 6", 1985, 60, 2024, 26);
		b3 = b3.addBuilding(ob2);
		b3 = b3.addBuilding(ob3);
		b3 = b3.addBuilding(ob4);
		b3= b3.addBuilding (ob8);
		b3 = b3.addBuilding(ob5);		
		b3= b3.addBuilding (ob7);
		b3= b3.addBuilding (ob6);
		*/
